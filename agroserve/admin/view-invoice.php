...
<html>
<head>
	<title>Agroserve || View Invoice </title>
...
$sql="select distinct tblclient.ContactName,tblclient.ShopName,tblclient.Workphnumber,tblclient.Email,tblclient.AccountID,tblinvoice.BillingId,tblinvoice.PostingDate from  tblclient   
...
<?php
$ret="select tblservices.OrderName,tblservices.OrderPrice  
	from  tblinvoice 
...
<td><?php echo "$".$subtotal=$row1->OrderPrice?></td>
</tr>

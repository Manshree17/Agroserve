...
<html>
<head>
	<title>Agroserve || Between dates reports </title>
								...
								<table class="table" border="1"> <thead> <tr> <th>#</th> 
									...
									<th>Company Name</th>
									 ...
									 <th>Action</th>
									    ...
									    <tbody>
									    	<?php
$sql="select distinct tblclient.ContactName,tblclient.ShopName,tblinvoice.BillingId,tblinvoice.PostingDate from  tblclient   

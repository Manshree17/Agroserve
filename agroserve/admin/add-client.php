...
$sql="insert into tblclient(AccountID,AccountType,ContactName,ShopName,Address,City,State,ZipCode,Workphnumber,Cellphnumber,Otherphnumber,Email,WebsiteAddress,Notes,Password)values(:acctid,:accttype,:cname,:comname,:address,:city,:state,:zcode,:wphnumber,:cellphnumber,:ophnumber,:email,:websiteadd,:notes,:password)";
...
<html>
<head>
	<title>Agroserve|| Add Clients</title>
...
<form method="post"> 
	...
	<div class="form-group"> <label for="exampleInputEmail1">Shop Name</label> <input type="text" name="comname" placeholder="Company Name" value="" class="form-control" required='true'> </div>

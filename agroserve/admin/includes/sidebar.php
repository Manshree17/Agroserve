 <div class="sidebar-menu">
    <header class="logo">
        <a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="dashboard.php"> <span id="logo"> <h1>Agroserve</h1></span> 
...
{               ?>
        <a href="dashboard.php"><img src="images/adminmain.png" height="70" width="70"></a>
        ...
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Orders</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="add-orders.php"> Add Orders</a></li>
                    <li id="menu-academico-boletim" ><a href="manage-orders.php">Manage Orders</a></li>

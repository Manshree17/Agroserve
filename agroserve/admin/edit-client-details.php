...
$sql="update tblclient set AccountType=:accttype,ContactName=:cname,ShopName=:comname,Address=:address,City=:city,State=:state,ZipCode=:zcode,Workphnumber=:wphnumber,Cellphnumber=:cellphnumber,Otherphnumber=:ophnumber,Email=:email,WebsiteAddress=:websiteadd,Notes=:notes where ID=:eid";
...
<html>
<head>
	<title>Agroserve|| Update Clients</title>
...
{               ?>								
	...
	<div class="form-group"> <label for="exampleInputEmail1">Shop Name</label> <input type="text" name="comname" value="<?php  echo $row->ShopName;?>" class="form-control" required='true'> </div>

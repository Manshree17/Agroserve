...
?>	
						...
						<div class="col-md-4 widget">
							<div class="stats-left">
								<?php
$sql6="select  sum(tblservices.OrderPrice) as todaysale
 from tblinvoice 
				...
				<div class="custom-widgets">
					<div class="row-one">
						...
						<div class="col-md-4 widget states-mdl">
							<div class="stats-left">
								<?php
$sql7="select  sum(tblservices.OrderPrice) as totalcost
 from tblinvoice 
...
$yest_sale=$row7->totalcost;
  ...
  ?>
						...
						<div class="col-md-4 widget states-thrd">
							<div class="stats-left">
								<?php
$sql8="select  sum(tblservices.OrderPrice) as totalcost
 from tblinvoice 
...
$sevendays_sale=$row8->totalcost;
  ...
  ?>
						...
						<div class="col-md-4 widget states-last">
							<div class="stats-left">
								<?php
$sql9="select  sum(tblservices.OrderPrice) as totalcost
 from tblinvoice 

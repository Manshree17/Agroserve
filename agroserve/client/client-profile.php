...
if (strlen($_SESSION['clientmsuid']==0)) {
 ...
 $websiteadd=$_POST['websiteadd'];
  ...
  $sql="update tblclient set ContactName=:cname,ShopName=:comname,Address=:address,City=:city,State=:state,ZipCode=:zcode,Cellphnumber=:cellphnumber,Otherphnumber=:ophnumber,Email=:email,WebsiteAddress=:websiteadd where ID=:uid";
...
<html>
<head>
	<title>Agroserve|| Client Profile</title>
...
{               ?>
	...
	<div class="form-group"> <label for="exampleInputEmail1">Company Name</label> <input type="text" name="comname" value="<?php  echo $row->ShopName;?>" class="form-control" required="true"> </div>
